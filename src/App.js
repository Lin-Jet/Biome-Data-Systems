      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.wrapper}>
          <Typography variant="h4" className={classes.bigSpace} color="primary">
             At Biome Data Systems we innovate health and medical products TEMP
          </Typography>
          <Typography variant="h5" className={classes.littleSpace} color="primary">
            Our product is is wearable and cna detect when the user's health is in danger.  It sends a warning signal and can save lives.  TEMP
          </Typography>
        </div>
